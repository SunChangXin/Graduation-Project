...
vlog -vlog01compat -work work +incdir+. {my3_8.vo}

vlog -vlog01compat -work work +incdir+D:/ShuDianShiYan/my3_8 {D:/ShuDianShiYan/my3_8/my3_8_tb.v}

vsim -t 1ps -L altera_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L gate_work -L work -voptargs="+acc"  my3_8_tb
