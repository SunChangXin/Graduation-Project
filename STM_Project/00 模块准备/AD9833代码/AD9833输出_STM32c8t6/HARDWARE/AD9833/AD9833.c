...
#define		FSYNC_1()     	GPIO_SetBits(GPIOB,GPIO_Pin_15)//输出高
#define		FSYNC_0()   	GPIO_ResetBits(GPIOB,GPIO_Pin_15)//输出低
#define     SCK_1()			GPIO_SetBits(GPIOB,GPIO_Pin_14)//输出高
#define 	SCK_0()			GPIO_ResetBits(GPIOB,GPIO_Pin_14)//输出低
#define 	DAT_1()			GPIO_SetBits(GPIOB,GPIO_Pin_13)//输出高
#define 	DAT_0()			GPIO_ResetBits(GPIOB,GPIO_Pin_13)//输出低
