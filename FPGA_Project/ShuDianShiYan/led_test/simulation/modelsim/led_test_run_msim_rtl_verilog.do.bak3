...
vlog -vlog01compat -work work +incdir+D:/ShuDianShiYan/led_test {D:/ShuDianShiYan/led_test/led_test.v}

vlog -vlog01compat -work work +incdir+D:/ShuDianShiYan/led_test {D:/ShuDianShiYan/led_test/led_test_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L rtl_work -L work -voptargs="+acc"  led_test_tb
