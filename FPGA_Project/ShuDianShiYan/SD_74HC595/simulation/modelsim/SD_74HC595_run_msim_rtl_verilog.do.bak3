...
vlog -vlog01compat -work work +incdir+D:/ShuDianShiYan/My_74HC595 {D:/ShuDianShiYan/My_74HC595/My_74HC595.v}
vlog -vlog01compat -work work +incdir+D:/ShuDianShiYan/debounce {D:/ShuDianShiYan/debounce/debounce.v}
vlog -vlog01compat -work work +incdir+D:/ShuDianShiYan/SD_74HC595 {D:/ShuDianShiYan/SD_74HC595/SD_74HC595.v}

vlog -vlog01compat -work work +incdir+D:/ShuDianShiYan/SD_74HC595 {D:/ShuDianShiYan/SD_74HC595/SD_74HC595_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L rtl_work -L work -voptargs="+acc"  SD_74HC595_tb
